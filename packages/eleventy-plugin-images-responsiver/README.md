...
Read more about the limits of the plugin default behavior, and how to add some configuration to enhance it (a lot), in [`images-responsiver` tutorial](https://nhoizey.github.io/images-responsiver/tutorial-01-without-images-responsiver.html).
