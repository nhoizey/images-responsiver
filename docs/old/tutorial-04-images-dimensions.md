...
<script src="https://gist-it.appspot.com/github/nhoizey/images-responsiver/raw/main/docs/examples/04-images-dimensions/page.html?footer=minimal"></script>

If we run the exact same Node.js script on it:

<script src="https://gist-it.appspot.com/github/nhoizey/images-responsiver/raw/main/docs/examples/04-images-dimensions/run.js?footer=minimal"></script>

The result is further improved:

<script src="https://gist-it.appspot.com/github/nhoizey/images-responsiver/raw/main/docs/examples/04-images-dimensions/page-enhanced.html?footer=minimal"></script>
...
<script src="https://gist-it.appspot.com/github/nhoizey/images-responsiver/raw/main/docs/examples/04-images-dimensions/styles.css?footer=minimal"></script>
